...
$misAmigos = ["Jhonathan","Jorge","Ferrer"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Miguel", "Richi"); // Reemplaza las comillas vacías con los nombres de tus amigos
